...
extern NSString *const QIMSDWebImageDownloadReceiveResponseNotification;
extern NSString *const QIMSDWebImageDownloadStopNotification;
extern NSString *const QIMSDWebImageDownloadFinishNotification;

@interface QIMSDWebImageDownloaderOperation : NSOperation <QIMSDWebImageOperation, NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
...
/**
 * The QIMSDWebImageDownloaderOptions for the receiver.
 */
@property (assign, nonatomic, readonly) QIMSDWebImageDownloaderOptions options;
...
/**
 *  Initializes a `QIMSDWebImageDownloaderOperation` object
 *
 *  @see QIMSDWebImageDownloaderOperation
 *
