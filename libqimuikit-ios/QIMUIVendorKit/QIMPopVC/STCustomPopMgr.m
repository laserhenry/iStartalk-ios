...
+ (void)showPopVC:(UIViewController *)popVc withRootVC:(UIViewController *)rootVc {
    ...
    STCustomPresentationController *presentationController NS_VALID_UNTIL_END_OF_SCOPE;
    
    presentationController = [[STCustomPresentationController alloc] initWithPresentedViewController:popVc presentingViewController:rootVc];
