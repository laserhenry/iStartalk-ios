...
Pod::Spec.new do |s|
  ...
  s.subspec 'PublicUIHeader'  do |ph|
    ph.public_header_files = "QIMUIKit/STNotificationMgr*.{h}", "QIMUIKit/STJumpURLHandle*.{h}", "QIMUIKit/STFastEntrance*.{h}", "QIMUIKit/STAppWindowMgr*.{h}", "QIMUIKit/QIMCommonUIFramework*.*{h}", "QIMUIKit/STRemoteNotificationMgr*.{h}"
    ph.source_files = "QIMUIKit/STNotificationMgr*.{h,m,c,mm}", "QIMUIKit/STJumpURLHandle*.{h,m,c,mm}", "QIMUIKit/STFastEntrance*.{h,m,c,mm}", "QIMUIKit/STAppWindowMgr*.{h,m,c,mm}", "QIMUIKit/QIMCommonUIFramework*.*{h,m,c,mm}", "QIMUIKit/STRemoteNotificationMgr*.{h,m,c,mm}"
  end
