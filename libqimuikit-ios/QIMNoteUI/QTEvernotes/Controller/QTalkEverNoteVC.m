...
@interface QTalkEverNoteVC () <WKNavigationDelegate,WKNavigationDelegate>
...
// 在发送请求之前，决定是否跳转
- (void)webView2:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler{
