...
- (void)downloadQIMRNExternalAppWithBundleParams:(NSDictionary *)params withCallBack:(QIMKitDownloadQIMRNExternalAppBundleSuccessCallBack)callBack {
    ...
    if (bundleUrls.length > 0) {
        ...
        [[STKit sharedInstance] sendTPGetRequestWithUrl:bundleUrls withSuccessCallBack:^(NSData *bundleData) {
            ...
            if (bundleData.length > 0) {
                ...
                NSString *bundleMD5Name = [[[STKit sharedInstance] qim_cachedFileNameForKey:bundleUrls] stringByAppendingFormat:@".jsbundle"];
