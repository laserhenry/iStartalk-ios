...
- (NSDictionary *)getNewSearchInitialProps {
    ...
    [initialProps setQIMSafeObject:[[STKit sharedInstance] qimNav_New_SearchUrl] forKey:@"searchUrl"];
    ...
    [initialProps setQIMSafeObject:[[STKit sharedInstance] qimNav_InnerFileHttpHost] forKey:@"imageHost"];
    [initialProps setQIMSafeObject:[[STKit sharedInstance] getLastJid] forKey:@"MyUserId"];
    NSArray *searchKeyHistory = [[STKit sharedInstance] getLocalSearchKeyHistoryWithSearchType:QIMSearchTypeAll withLimit:5];
