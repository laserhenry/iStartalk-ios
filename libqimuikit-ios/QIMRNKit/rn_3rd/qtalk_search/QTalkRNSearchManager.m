...
+ (NSDictionary *)rnSearchLocalUserChatResultWithSearchKey:(NSString *)key limit:(NSInteger)limit offset:(NSInteger)offset  {
    ...
    NSArray *localUserList = [[STKit sharedInstance] searchUserListBySearchStr:key WithLimit:limit WithOffset:offset];
    NSInteger totalCount = [[STKit sharedInstance] searchUserListTotalCountBySearchStr:key];
...
+ (NSDictionary *)rnSearchLocalGroupChatResultWithSearchKey:(NSString *)key limit:(NSInteger)limit offset:(NSInteger)offset  {
    ...
    NSArray *localGroupList = [[STKit sharedInstance] searchGroupBySearchStr:key WithLimit:limit WithOffset:offset];
    NSInteger totalCount = [[STKit sharedInstance] searchGroupTotalCountBySearchStr:key];
...
+ (NSDictionary *)rnSearchEjabhost2GroupChatResultWithSearchKey:(NSString *)key limit:(NSInteger)limit offset:(NSInteger)offset  {
    ...
    NSArray *ejabhost2GroupChatList = [[STKit sharedInstance] rnSearchEjabHost2GroupChatListByKeyStr:key limit:limit offset:offset];
    NSInteger totalCount = [[STKit sharedInstance] getRNSearchEjabHost2GroupChatListByKeyStr:key];
...
+ (NSDictionary *)rnSearchPublicNumberResultWithSearchKey:(NSString *)key limit:(NSInteger)limit offset:(NSInteger)offset {
    NSArray *publicNumberList = [[STKit sharedInstance] rnSearchPublicNumberListByKeyStr:key limit:limit offset:offset];
    NSInteger totalCount = [[STKit sharedInstance] getRnSearchPublicNumberListByKeyStr:key];
...
+ (NSString *)searchUrl {
    return [[STKit sharedInstance] qimNav_SearchUrl];
}
