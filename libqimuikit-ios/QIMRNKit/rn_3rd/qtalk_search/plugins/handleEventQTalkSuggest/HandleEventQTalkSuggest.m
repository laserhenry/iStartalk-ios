...
-(void) goUserCard:(NSString*) uri{
    dispatch_async(dispatch_get_main_queue(), ^{
        [STFastEntrance openUserCardVCByUserId:uri];
    });
}
-(void) goGroupChat:(NSString*) uri{
    dispatch_async(dispatch_get_main_queue(), ^{
        [STFastEntrance openGroupChatVCByGroupId:uri];
    });
}
...
-(void) goWebView:(NSString*) uri
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        [STFastEntrance openWebViewForUrl:uri showNavBar:showNavBar];
    });
}

-(void) goSingleChat:(NSString*) uri{
    dispatch_async(dispatch_get_main_queue(), ^{
        [STFastEntrance openSingleChatVCByUserId:uri];
    });
}

-(void) goRobotCard:(NSString *)uri {
    dispatch_async(dispatch_get_main_queue(), ^{
        [STFastEntrance openRobotCard:uri];
    });
}
