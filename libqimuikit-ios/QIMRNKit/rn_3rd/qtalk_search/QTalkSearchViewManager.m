...
- (void)viewDidLoad {
    ...
    if (![[STKit sharedInstance] getIsIpad] && [[UIApplication sharedApplication] statusBarOrientation] != UIInterfaceOrientationPortrait) {
    ...
    NSNumber *forceOldSearch = [[STKit sharedInstance] userObjectForKey:@"forceOldSearch"];
    //iPad版/qchat App使用老版本搜索
    if ([forceOldSearch boolValue] == YES || [[STKit sharedInstance] getIsIpad] == YES || [STKit getQIMProjectType] == QIMProjectTypeQChat) {
