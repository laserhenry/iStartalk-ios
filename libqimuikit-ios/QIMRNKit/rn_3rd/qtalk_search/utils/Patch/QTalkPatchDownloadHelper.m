...
{
    [[STKit sharedInstance] sendTPGetRequestWithUrl:url withSuccessCallBack:^(NSData *responseData) {
...
//                    errorMsg = @"md5 check error";
                    ...
                    if(success){
                        ...
                        NSString *md5 = [[STKit sharedInstance] qim_getFileMD5WithPath:destPath];
