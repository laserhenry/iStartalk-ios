...
+ (NSArray *)qimrn_getGroupMembersByGroupId:(NSString *)groupId {
    NSArray *groupMembers = [[STKit sharedInstance] getGroupMembersByGroupId:groupId];
    ...
    for (NSDictionary *member in groupMembers) {
        ...
        QIMGroupIdentity groupIdentity = [[STKit sharedInstance] GroupIdentityForUser:userJid byGroup:groupId];
        NSString *userName = [[STKit sharedInstance] getUserMarkupNameWithUserId:userJid];
...
+ (NSDictionary *)qimrn_getGroupInfoByGroupId:(NSString *)groupId {
    ...
    NSDictionary *groupInfo = [[STKit sharedInstance] getGroupCardByGroupId:groupId];
