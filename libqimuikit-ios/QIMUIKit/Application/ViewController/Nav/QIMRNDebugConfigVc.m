...
- (UITextView *)opsRNTextView {
    if (!_opsRNTextView) {
        ...
        NSString *opsFoundRNDebugUrl = [[STKit sharedInstance] userObjectForKey:@"opsFoundRNDebugUrl"];
...
- (UITextView *)searchRNTextView {
    if (!_searchRNTextView) {
        ...
        NSString *qtalkSearchRNDebugUrl = [[STKit sharedInstance] userObjectForKey:@"qtalkSearchRNDebugUrl"];
...
- (UITextView *)qtalkRNTextView {
    if (!_qtalkRNTextView) {
        ...
        NSString *qtalkFoundRNDebugUrl = [[STKit sharedInstance] userObjectForKey:@"qtalkFoundRNDebugUrl"];
...
- (void)saverRNDebugConfig {
    [[STKit sharedInstance] setUserObject:self.opsRNTextView.text forKey:@"opsFoundRNDebugUrl"];
    [[STKit sharedInstance] setUserObject:self.searchRNTextView.text forKey:@"qtalkSearchRNDebugUrl"];
    [[STKit sharedInstance] setUserObject:self.qtalkRNTextView.text forKey:@"qtalkFoundRNDebugUrl"];
