...
- (NSMutableArray *)navConfigUrls {
    if (!_navConfigUrls) {
        _navConfigUrls = [[STKit sharedInstance] qimNav_localNavConfigs];  
    }
...
- (void)onCancel{
    dispatch_async(dispatch_get_main_queue(), ^{
        [[STFastEntrance sharedInstance] launchMainControllerWithWindow:[UIApplication sharedApplication].delegate.window];
        /*
