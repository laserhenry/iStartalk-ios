...
- (void)getChatBgById:(NSString *)userId ByName:(NSString *)name WithReset:(BOOL)reset Complete:(void(^)(UIImage *bgImage)) complete {
    NSString *fileName = [[[NSString stringWithFormat:@"%@_%@_%@",userId,name?name:userId, [[STKit sharedInstance] AppBuildVersion]] dataUsingEncoding:NSUTF8StringEncoding] qim_md5String];
