...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        BOOL swicthOn = [[STKit sharedInstance] groupPushState:self.groupId];
...
- (void)onSwitchClicked:(UISwitch *) sender {
    BOOL swicthOn = [[STKit sharedInstance] groupPushState:self.groupId];
    [[STKit sharedInstance] updatePushState:self.groupId withOn:!swicthOn withCallback:nil];
}
...
- (void)refreshUI{
    ...
    BOOL switchOn = [[STKit sharedInstance] groupPushState:self.groupId];
