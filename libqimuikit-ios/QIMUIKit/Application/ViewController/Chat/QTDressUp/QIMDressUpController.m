...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([text isEqualToString:@"cap"]) {
        ...
        NSMutableDictionary * chatBGImageDic = [[STKit sharedInstance] userObjectForKey:@"chatBGImageDic"];
        UIImage * image = nil;
        if (chatBGImageDic) {
            image = [UIImage imageWithContentsOfFile:[[STDataContraller getInstance] getSourcePath:@"chatBGImageFor_Common"]];
        }
