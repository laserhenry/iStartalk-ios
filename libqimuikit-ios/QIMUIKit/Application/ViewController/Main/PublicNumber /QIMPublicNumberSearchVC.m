...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([tableView isEqual:_mySearchDisplayController.searchResultsTableView]) {
        ...
        [cell setJid:[NSString stringWithFormat:@"%@@%@",cell.publicNumberId,[[STKit sharedInstance] getDomain]]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([[STKit sharedInstance] getPublicNumberCardByJid:cell.jid]) {
...
//    _searchDataSource = [[QIMKit sharedInstance] searchRobotByKeyStr:[searchBar text]];
    [[STKit sharedInstance] searchRobotByKeyStr:[searchBar text] withCallBack:^(NSArray *list) {
