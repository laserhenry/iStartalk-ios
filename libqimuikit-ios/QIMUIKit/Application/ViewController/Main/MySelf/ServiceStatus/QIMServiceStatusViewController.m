...
- (NSArray *)serviceStatus {
    if (!_serviceStatus) {
        _serviceStatus = [[STKit sharedInstance] availableUserSeatStatus];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (status != shopServiceStatus) {
        ...
        [[STKit sharedInstance] updateSeatSeStatusWithShopId:shopId WithStatus:status withCallBack:^(BOOL res) {
