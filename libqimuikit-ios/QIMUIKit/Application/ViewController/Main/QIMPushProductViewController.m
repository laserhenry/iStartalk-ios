...
-(void)searchBtnHandle:(id)sender{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        [[STKit sharedInstance] sendTPPOSTFormUrlEncodedRequestWithUrl:[NSString stringWithFormat:@"%@/api/pdt/productDtl.qunar?pdtId=%@&line=%@",@"https://qcadmin.qunar.com",_searchTextField.text,@"dujia"] withRequestBodyData:nil withSuccessCallBack:^(NSData *responseData) {
