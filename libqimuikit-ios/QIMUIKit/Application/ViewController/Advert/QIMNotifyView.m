        ...
        if ([type isEqualToString:@"request"]) {
                                ...
                                if ([type isEqualToString:@"link"]) {
                                    ...
                                    if (isConsult) {
                                        if (chatType == ChatType_Consult) {
                                            [STFastEntrance openConsultChatByChatType:ChatType_Consult UserId:realTo WithVirtualId:to];
                                        } else {
                                            [STFastEntrance openConsultChatByChatType:ChatType_ConsultServer UserId:realTo WithVirtualId:to];
                                        }
                                    } else {
                                        [STFastEntrance openSingleChatVCByUserId:realFrom];
                                    }
                                    [self closeNotifView];
                                } else {
            ...
            if (isConsult) {
                if (chatType == ChatType_Consult) {
                    ...
                    [STFastEntrance openConsultChatByChatType:ChatType_ConsultServer UserId:realFrom WithVirtualId:from];
                }
            } else {
                [STFastEntrance openSingleChatVCByUserId:realFrom];
            }
