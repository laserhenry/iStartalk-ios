...
//            QIMVerboseLog(@"查看大图");
        ...
        case QCUserProfileUserSignature: {
            ...
            mySignVC.userId = [[STKit sharedInstance] getLastJid];
        ...
        case QCUserProfileMyQrcode: {
            [STFastEntrance showQRCodeWithQRId:self.userId withType:QRCodeType_UserQR];
        }
            break;
        ...
        case QCUserProfileSendMail: {
            ...
            [[STFastEntrance sharedInstance] sendMailWithRootVc:self.rootVC ByUserId:userId.length?userId:@"lilulucas.li"];
        }
            break;
        default:
            break;
...
//            cell.avatarImage.image = [[QIMKit sharedInstance] getUserHeaderImageByUserId:self.userId];
        ...
        case QCUserProfileRemark: {
            ...
            cell.detailTextLabel.textColor = [UIColor qtalkTextLightColor];
            cell.accessoryType = UITableViewCellAccessoryDisclosureIndicator;
            NSString * remarkName = [[STKit sharedInstance] getUserMarkupNameWithUserId:self.userId];
        ...
        case QCUserProfileDepartment: {
            ...
            if (cell == nil) {
                cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:cellIdentifier];
                [cell.textLabel setText:[STKit getQIMProjectType] == QIMProjectTypeQChat ? [NSBundle qim_localizedStringForKey:@"user_introduce"] : [NSBundle qim_localizedStringForKey:@"user_department"]];
...
#pragma mark - 查看大图
    ...
    //3. 本地路径不存在 -> 直接加载URL
    NSString *headerUrl = [[STKit sharedInstance] getUserHeaderSrcByUserId:self.userId];
