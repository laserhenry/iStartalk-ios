...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _platFormLabel.text = ([STKit getQIMProjectType] == QIMProjectTypeQChat) ? @"来自QChat" : @"来自QTalk";
...
- (void)refreshUI {
    ...
    if (!fileMd5.length) {
        fileMd5 = [[STKit sharedInstance] getFileNameFromUrl:fileUrl];
    }
    ...
    NSString *filePath = [[[STKit sharedInstance] getDownloadFilePath] stringByAppendingPathComponent:[NSString stringWithFormat:@"%@", fileMd5?fileMd5:@""]];
