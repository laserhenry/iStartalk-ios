...
@interface STImgAssetViewController ()<UITableViewDelegate,UITableViewDataSource,STImgAssetCellDelegate,UIActionSheetDelegate,QIMImageEditViewControllerDelegate>{
...
@implementation STImgAssetViewController
...
- (void)onPreviewClick{
    STImgPickerController *picker = (STImgPickerController *)self.navigationController;
    STImgPreviewController *previewVC = [[STImgPreviewController alloc] init];
...
- (NSMutableArray *)indexPathsForSelectedItems{
    STImgPickerController *vc = (STImgPickerController *)self.navigationController;
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
   ...
   STImgAssetCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell==nil) {
        cell=[[STImgAssetCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
        STImgPickerController *vc = (STImgPickerController *)self.navigationController;
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    return [STImgAssetCell getCellHeight];
}
...
- (BOOL)shouldSelectAsset:(ALAsset *)asset
{
    ...
    if (picker.indexPathsForSelectedItems.count >= picker.maximumNumberOfSelection) {
        if (picker.delegate!=nil&&[picker.delegate respondsToSelector:@selector(qtImagePickerControllerDidMaximum:)]) {
            ...
            [STTipsView showTips:[NSString stringWithFormat:[NSBundle qim_localizedStringForKey:@"Select a maximum of %d photos"],(int)picker.maximumNumberOfSelection] InView:self.view];
        }
    }
