...
#import "STImgAlbumViewController.h"

#import "STImgPickerController.h"

#import "STImgAlbumCell.h"

#import "STImgAssetViewController.h"

@interface STImgAlbumViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation STImgAlbumViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    STImgAlbumCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil)
    {
        cell = [[STImgAlbumCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:CellIdentifier];
    }
...
{
    return [STImgAlbumCell getCellHeight];
}

- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    [[tableView cellForRowAtIndexPath:indexPath] setSelected:NO animated:YES];
    STImgAssetViewController *vc = [[STImgAssetViewController alloc] init];
