...
@interface STImgAssetView ()<STImgAssetTapViewDelegate>

@property (nonatomic, strong) ALAsset *asset; 
@property (nonatomic, retain) UIImageView *imageView;
@property (nonatomic, retain) QTVideoTitleView *videoTitle;
@property (nonatomic, retain) STImgAssetTapView *tapAssetView;

@end

@implementation STImgAssetView
...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame])
    {
        ...
        _tapAssetView=[[STImgAssetTapView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, frame.size.height)];
