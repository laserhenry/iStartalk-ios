...
@interface STPHGridViewCell ()
@end


@implementation STPHGridViewCell
...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _videoIcon.image = [UIImage imageNamed:@"QTPHVideoIcon" inBundle:[NSBundle bundleForClass:STPHGridViewCell.class] compatibleWithTraitCollection:nil];
        ...
        [_selectedButton setImage:[UIImage imageNamed:@"photo_browser_checxbox_sel" inBundle:[NSBundle bundleForClass:STPHGridViewCell.class] compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
