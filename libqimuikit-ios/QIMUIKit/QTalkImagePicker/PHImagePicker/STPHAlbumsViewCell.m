...
@implementation STPHAlbumsViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        _videoIcon.image = [UIImage imageNamed:@"QTPHVideoIcon" inBundle:[NSBundle bundleForClass:STPHAlbumsViewCell.class] compatibleWithTraitCollection:nil];
