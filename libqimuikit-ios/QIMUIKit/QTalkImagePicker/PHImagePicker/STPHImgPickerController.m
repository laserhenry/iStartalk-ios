...
@interface STPHImgPickerController () <UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIAlertViewDelegate>

@end

@implementation STPHImgPickerController
...
- (void)setupNavigationController
{
    ...
    STPHAlbumsViewController *albumsViewController = [[STPHAlbumsViewController alloc] init];
...
//    [self updateDoneButton];
    ...
    if (!self.allowsMultipleSelection) {
        if (self.confirmSingleSelection) {
            NSString *message = self.confirmSingleSelectionPrompt ? self.confirmSingleSelectionPrompt : [NSString stringWithFormat:NSLocalizedStringFromTableInBundle(@"picker.confirm.message",  @"GMImagePicker", [NSBundle bundleForClass:STPHImgPickerController.class],  @"Do you want to select the image you tapped on?")];
            
            [[[UIAlertView alloc] initWithTitle:[NSString stringWithFormat:NSLocalizedStringFromTableInBundle(@"picker.confirm.title",  @"GMImagePicker", [NSBundle bundleForClass:STPHImgPickerController.class],  @"Are You Sure?")]
                                        message:message
                                       delegate:self
                              cancelButtonTitle:[NSString stringWithFormat:NSLocalizedStringFromTableInBundle(@"picker.action.no",  @"GMImagePicker", [NSBundle bundleForClass:STPHImgPickerController.class],  @"No")]
                              otherButtonTitles:[NSString stringWithFormat:NSLocalizedStringFromTableInBundle(@"picker.action.yes",  @"GMImagePicker", [NSBundle bundleForClass:STPHImgPickerController.class],  @"Yes")], nil] show];
        } else {
            [self finishPickingAssets:self];
        }
...
- (void)cameraButtonPressed:(UIBarButtonItem *)button
{
    ...
    if (self.autoSelectCameraImages && [self.navigationController.topViewController isKindOfClass:[STPHAlbumsViewController class]]) {
        [((STPHAlbumsViewController *)self.navigationController.topViewController) selectAllAlbumsCell];
    }
