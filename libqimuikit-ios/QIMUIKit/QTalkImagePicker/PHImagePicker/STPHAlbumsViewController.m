...
#import "STPHAlbumsViewCell.h"

@interface STPHAlbumsViewController() <PHPhotoLibraryChangeObserver>
...
@implementation STPHAlbumsViewController
...
- (STPHImgPickerController *)picker
{
    return (STPHImgPickerController *)self.navigationController.parentViewController;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    STPHAlbumsViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[STPHAlbumsViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:CellIdentifier];
...
{
    STPHAlbumsViewCell *cell = (STPHAlbumsViewCell *)[tableView cellForRowAtIndexPath:indexPath];
    
    // Init the GMGridViewController
    STPHGridViewController *gridViewController = [[STPHGridViewController alloc] initWithPicker:[self picker]];
    // Set the title
