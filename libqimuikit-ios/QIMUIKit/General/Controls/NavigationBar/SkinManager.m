...
+ (void)setMainBgType:(SkinMainBgType)bgType{
    ...
    [[STKit sharedInstance] setUserObject:[NSNumber numberWithInt:bgType] forKey:@"SkinMainBgType"];
...
+ (SkinMainBgType)getMainBgType{
    return [[[STKit sharedInstance] userObjectForKey:@"SkinMainBgType"] intValue];
}
