...
- (NSArray<RCTModuleData *> *)registerModulesForClasses:(NSArray<id<RCTBridgeModule>> *)moduleClasses
{
...
- (void)registerAdditionalModuleClasses:(NSArray<id<RCTBridgeModule>> *)modules
{
