...
@interface STVoiceNoReadStateMgr ()

@property (nonatomic, assign) BOOL isRead;

@end

static STVoiceNoReadStateMgr *__voiceNoReadStateManager = nil;
static NSMutableDictionary *_voiceNoReadStateDict = nil;
@implementation STVoiceNoReadStateMgr

+ (instancetype)sharedVoiceNoReadStateManager {
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        __voiceNoReadStateManager = [[STVoiceNoReadStateMgr alloc] init];
    });
