...
@implementation STDataMgr (QIMDBGroup)
...
- (NSArray *)qimDB_rnSearchEjabHost2GroupChatListByKeyStr:(NSString *)keyStr limit:(NSInteger)limit offset:(NSInteger)offset {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:value setObject:groupId forKey:@"uri"];
            [STDataMgr safeSaveForDic:value setObject:label forKey:@"label"];
            [STDataMgr safeSaveForDic:value setObject:groupTopic forKey:@"content"];
            [STDataMgr safeSaveForDic:value setObject:groupIcon forKey:@"icon"];
...
- (NSArray *)qimDB_searchGroupByUserIds:(NSArray *)userIds WithLimit:(NSInteger)limit WithOffset:(NSInteger)offset {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:dic setObject:groupId forKey:@"GroupId"];
            [STDataMgr safeSaveForDic:dic setObject:name forKey:@"Name"];
            [STDataMgr safeSaveForDic:dic setObject:introduce forKey:@"Introduce"];
            [STDataMgr safeSaveForDic:dic setObject:headerSrc forKey:@"HeaderSrc"];
            [STDataMgr safeSaveForDic:dic setObject:topic forKey:@"Topic"];
            [STDataMgr safeSaveForDic:dic setObject:lastUpdateTime forKey:@"LastUpdateTime"];
            [STDataMgr safeSaveForDic:dic setObject:@(ExtendedFlag) forKey:@"ExtendedFlag"];
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            if (groupId.length > 0) {
                ...
                NSMutableDictionary *dic = [NSMutableDictionary dictionary];
                [STDataMgr safeSaveForDic:dic setObject:groupId forKey:@"GroupId"];
                [STDataMgr safeSaveForDic:dic setObject:lastUpdateTime?lastUpdateTime:@(0) forKey:@"LastUpdateTime"];
                [groupList addObject:dic];
            }
        }
    }];
...
- (void)qimDB_bulkUpdateIncrementGroupCards:(NSArray *)array{
    ...
    [[STDataMgr qimDB_SharedInstance] qimDB_UpdateUserCacheDataWithKey:@"kGetIncrementMucGroupCardVersion" withType:12 withValue:@"获取群增量名片" withValueInt:maxUTTime];
    QIMVerboseLog(@"");
}

- (NSInteger)qimDB_getGroupListMaxUTLastUpdateTime {
    NSInteger lastMaxUTTime = [[STDataMgr qimDB_SharedInstance] qimDB_getUserCacheDataWithKey:@"kGetIncrementMucGroupCardVersion" withType:12];
