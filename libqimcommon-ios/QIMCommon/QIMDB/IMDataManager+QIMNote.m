...
@implementation STDataMgr (QIMNote)
...
- (BOOL)checkExitsMainItemWithQid:(NSInteger)qid WithCId:(NSInteger)cid {
    ...
    if (cid < 1) {
        cid = [[STDataMgr qimDB_SharedInstance] getMaxQTNoteMainItemCid] + 1;
    }
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            if (needConvertToStringFlag) {
                ...
                [STDataMgr safeSaveForDic:paramDic setObject:strCid forKey:@"cid"];
            } else {
                [STDataMgr safeSaveForDic:paramDic setObject:c_id forKey:@"c_id"];
            }
            [STDataMgr safeSaveForDic:paramDic setObject:q_type forKey:@"type"];
            [STDataMgr safeSaveForDic:paramDic setObject:q_title ? q_title : @"" forKey:@"title"];
            [STDataMgr safeSaveForDic:paramDic setObject:q_introduce ? q_introduce : @"" forKey:@"desc"];
            [STDataMgr safeSaveForDic:paramDic setObject:q_content ? q_content : @"" forKey:@"content"];
...
- (NSArray *)getQTNotesMainItemWithParams:(NSString *)param {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            NSMutableDictionary *paramDic = [[NSMutableDictionary alloc] init];
            [STDataMgr safeSaveForDic:paramDic setObject:q_id forKey:@"q_id"];
            [STDataMgr safeSaveForDic:paramDic setObject:c_id forKey:@"c_id"];
            [STDataMgr safeSaveForDic:paramDic setObject:q_type forKey:@"q_type"];
            [STDataMgr safeSaveForDic:paramDic setObject:q_title forKey:@"q_title"];
            [STDataMgr safeSaveForDic:paramDic setObject:q_introduce forKey:@"q_introduce"];
            [STDataMgr safeSaveForDic:paramDic setObject:q_content forKey:@"q_content"];
            [STDataMgr safeSaveForDic:paramDic setObject:q_time forKey:@"q_time"];
            [STDataMgr safeSaveForDic:paramDic setObject:q_state forKey:@"q_state"];
            [STDataMgr safeSaveForDic:paramDic setObject:q_ExtendedFlag forKey:@"q_ExtendedFlag"];
            [resultList addObject:paramDic];
        }
...
- (BOOL)checkExitsSubItemWithQsid:(NSInteger)qsid WithCsid:(NSInteger)csid {
    __block BOOL existFlag = NO;
    if (csid < 1) {
        csid = [[STDataMgr qimDB_SharedInstance]getMaxQTNoteSubItemCSid] + 1;
    }
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            if (needConvertToStringFlag) {
                ...
                [STDataMgr safeSaveForDic:paramDic setObject:strCsid forKey:@"csid"];
            } else {
                [STDataMgr safeSaveForDic:paramDic setObject:cs_id forKey:@"cs_id"];
            }
            [STDataMgr safeSaveForDic:paramDic setObject:qs_id forKey:@"qsid"];
            [STDataMgr safeSaveForDic:paramDic setObject:Qid forKey:@"qid"];
            [STDataMgr safeSaveForDic:paramDic setObject:qs_type forKey:@"type"];
            [STDataMgr safeSaveForDic:paramDic setObject:qs_title ? qs_title : @"" forKey:@"title"];
            [STDataMgr safeSaveForDic:paramDic setObject:qs_introduce ? qs_introduce : @"" forKey:@"desc"];
            [STDataMgr safeSaveForDic:paramDic setObject:qs_content ? qs_content : @"" forKey:@"content"];
            [resultList addObject:paramDic];
        }
...
- (NSArray *)getQTNotesSubItemWithParams:(NSString *)param {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            NSMutableDictionary *paramDic = [[NSMutableDictionary alloc] init];
            [STDataMgr safeSaveForDic:paramDic setObject:c_id forKey:@"c_id"];
            [STDataMgr safeSaveForDic:paramDic setObject:qs_id forKey:@"qs_id"];
            [STDataMgr safeSaveForDic:paramDic setObject:cs_id forKey:@"cs_id"];
            [STDataMgr safeSaveForDic:paramDic setObject:qs_type forKey:@"qs_type"];
            [STDataMgr safeSaveForDic:paramDic setObject:qs_title forKey:@"qs_title"];
            [STDataMgr safeSaveForDic:paramDic setObject:qs_introduce forKey:@"qs_introduce"];
            [STDataMgr safeSaveForDic:paramDic setObject:qs_content forKey:@"qs_content"];
            [STDataMgr safeSaveForDic:paramDic setObject:qs_time forKey:@"qs_time"];
            [STDataMgr safeSaveForDic:paramDic setObject:qs_state forKey:@"qs_state"];
            [STDataMgr safeSaveForDic:paramDic setObject:qs_ExtendedFlag forKey:@"qs_ExtendedFlag"];
            [resultList addObject:paramDic];
        }
