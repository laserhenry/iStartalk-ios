...
@implementation STDataMgr (QIMDBFriend)
...
- (NSMutableArray *)qimDB_selectFriendList {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:paramDic setObject:name.length>0?name:userId forKey:@"Name"];
            ...
            [STDataMgr safeSaveForDic:paramDic setObject:SearchIndex forKey:@"SearchIndex"];
            if (userInfoData) {
                [STDataMgr safeSaveForDic:paramDic setObject:[NSKeyedUnarchiver unarchiveObjectWithData:userInfoData] forKey:@"UserInfo"];
            }
...
- (NSDictionary *)qimDB_selectFriendInfoWithUserId:(NSString *)userId {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        if ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:resultDic setObject:userId forKey:@"UserId"];
            ...
            if (userInfoData) {
                [STDataMgr safeSaveForDic:resultDic setObject:[NSKeyedUnarchiver unarchiveObjectWithData:userInfoData] forKey:@"UserInfo"];
            }
        }
        [reader close];
    }];
...
- (NSMutableArray *)qimDB_selectFriendNotifys {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:paramDic setObject:userId forKey:@"UserId"];
            [STDataMgr safeSaveForDic:paramDic setObject:xmppId forKey:@"XmppId"];
            [STDataMgr safeSaveForDic:paramDic setObject:name forKey:@"Name"];
            [STDataMgr safeSaveForDic:paramDic setObject:descInfo forKey:@"DescInfo"];
            [STDataMgr safeSaveForDic:paramDic setObject:headerSrc forKey:@"HeaderSrc"];
            [STDataMgr safeSaveForDic:paramDic setObject:userInfo forKey:@"UserInfo"];
            [STDataMgr safeSaveForDic:paramDic setObject:state forKey:@"State"];
            [resultList addObject:paramDic];
        }
    }];
    QIMVerboseLog(@"");
...
- (NSDictionary *)qimDB_getLastFriendNotify {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        if ([reader read]) {
            ...
            friendNotify = [[NSMutableDictionary alloc] init];
            [STDataMgr safeSaveForDic:friendNotify setObject:userId forKey:@"UserId"];
            [STDataMgr safeSaveForDic:friendNotify setObject:xmppId forKey:@"XmppId"];
            [STDataMgr safeSaveForDic:friendNotify setObject:name forKey:@"Name"];
            [STDataMgr safeSaveForDic:friendNotify setObject:descInfo forKey:@"DescInfo"];
            [STDataMgr safeSaveForDic:friendNotify setObject:headerSrc forKey:@"HeaderSrc"];
            [STDataMgr safeSaveForDic:friendNotify setObject:userInfo forKey:@"UserInfo"];
            [STDataMgr safeSaveForDic:friendNotify setObject:state forKey:@"State"];
            [STDataMgr safeSaveForDic:friendNotify setObject:lastUpdateTime forKey:@"LastUpdateTime"];
        }
        [reader close];
    }];
    QIMVerboseLog(@"");
