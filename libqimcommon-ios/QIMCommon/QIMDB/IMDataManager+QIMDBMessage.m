...
@implementation STDataMgr (QIMDBMessage)
...
- (NSMutableArray *)qimDB_searchLocalMessageByKeyword:(NSString *)keyWord
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:value setObject:date forKey:@"time"];
            [STDataMgr safeSaveForDic:value setObject:@(time) forKey:@"timeLong"];
            [STDataMgr safeSaveForDic:value setObject:content forKey:@"content"];
            [STDataMgr safeSaveForDic:value setObject:nickName forKey:@"nickName"];
            [STDataMgr safeSaveForDic:value setObject:headUrl forKey:@"headerUrl"];
...
- (NSArray *)qimDB_getMgsListBySessionId:(NSString *)sesId{
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:msgDic setObject:chatType forKey:@"ChatType"];
            ...
            [STDataMgr safeSaveForDic:msgDic setObject:msgRaw forKey:@"MsgRaw"];
...
- (NSDictionary *)qimDB_getMsgsByMsgId:(NSString *)msgId {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        if ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:result setObject:msgId forKey:@"MsgId"];
            [STDataMgr safeSaveForDic:result setObject:xmppId forKey:@"XmppId"];
            [STDataMgr safeSaveForDic:result setObject:platform forKey:@"Platform"];
            [STDataMgr safeSaveForDic:result setObject:from forKey:@"From"];
            [STDataMgr safeSaveForDic:result setObject:to forKey:@"To"];
            [STDataMgr safeSaveForDic:result setObject:content forKey:@"Content"];
            [STDataMgr safeSaveForDic:result setObject:extendInfo forKey:@"ExtendInfo"];
            [STDataMgr safeSaveForDic:result setObject:msgType forKey:@"MsgType"];
            [STDataMgr safeSaveForDic:result setObject:chatType forKey:@"ChatType"];
            [STDataMgr safeSaveForDic:result setObject:msgState forKey:@"MsgState"];
            [STDataMgr safeSaveForDic:result setObject:msgDirection forKey:@"MsgDirection"];
            [STDataMgr safeSaveForDic:result setObject:contentResolve forKey:@"ContentResolve"];
            [STDataMgr safeSaveForDic:result setObject:readState forKey:@"ReadState"];
            [STDataMgr safeSaveForDic:result setObject:msgDateTime forKey:@"MsgDateTime"];
            [STDataMgr safeSaveForDic:result setObject:msgRaw forKey:@"MsgRaw"];
            [STDataMgr safeSaveForDic:result setObject:realJid forKey:@"RealJid"];
        }
        [reader close];
    }];
    CFAbsoluteTime end = CFAbsoluteTimeGetCurrent();
...
- (NSArray *)qimDB_getReceiveMsgIdListWithMsgReadFlag:(QIMMessageRemoteReadState)remoteReadState withChatType:(ChatType)chatType withMsgDirection:(QIMMessageDirection)receiveDirection {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:dict setObject:xmppId forKey:@"XmppId"];
            [STDataMgr safeSaveForDic:dict setObject:msgIds forKey:@"MsgIds"];
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase * _Nonnull db) {
        ...
        while ([reader read]) {
            ...
            if ([readState boolValue] == NO) {
                NSMutableDictionary *msgDic = [[NSMutableDictionary alloc] init];
                [STDataMgr safeSaveForDic:msgDic setObject:groupId forKey:@"GroupId"];
                [STDataMgr safeSaveForDic:msgDic setObject:msgId forKey:@"MsgId"];
                [STDataMgr safeSaveForDic:msgDic setObject:Type forKey:@"Type"];
                [STDataMgr safeSaveForDic:msgDic setObject:msgDate forKey:@"MsgDate"];
                [STDataMgr safeSaveForDic:msgDic setObject:readState forKey:@"ReadState"];
