...
@implementation STDataMgr (QIMUserMedal)
...
- (NSArray *)qimDB_getUserMedalsWithXmppId:(NSString *)xmppId {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:paramDic setObject:XmppId forKey:@"UserId"];
            [STDataMgr safeSaveForDic:paramDic setObject:type forKey:@"type"];
            [STDataMgr safeSaveForDic:paramDic setObject:URL forKey:@"url"];
            [STDataMgr safeSaveForDic:paramDic setObject:URLDesc forKey:@"desc"];
            [STDataMgr safeSaveForDic:paramDic setObject:LastUpdateTime forKey:@"LastUpdateTime"];
    ...
    if (userId.length <= 0) {
     ...
     [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
         ...
         if ([reader read]) {
             ...
             [STDataMgr safeSaveForDic:paramDic setObject:medalid forKey:@"medalId"];
             [STDataMgr safeSaveForDic:paramDic setObject:medalName forKey:@"medalName"];
             [STDataMgr safeSaveForDic:paramDic setObject:obtainCondition forKey:@"obtainCondition"];
             [STDataMgr safeSaveForDic:paramDic setObject:smallIcon forKey:@"smallIcon"];
             [STDataMgr safeSaveForDic:paramDic setObject:bigLightIcon forKey:@"bigLightIcon"];
             [STDataMgr safeSaveForDic:paramDic setObject:(BigGrayIcon.length > 0) ? BigGrayIcon : bigLightIcon forKey:@"bigGrayIcon"];
             [STDataMgr safeSaveForDic:paramDic setObject:bigLockIcon forKey:@"bigLockIcon"];
             [STDataMgr safeSaveForDic:paramDic setObject:status forKey:@"status"];
             [STDataMgr safeSaveForDic:paramDic setObject:userId forKey:@"medalUserId"];
             [STDataMgr safeSaveForDic:paramDic setObject:host forKey:@"medalUserHost"];
             [STDataMgr safeSaveForDic:paramDic setObject:medalStatus forKey:@"medalUserStatus"];
             [STDataMgr safeSaveForDic:paramDic setObject:userCount forKey:@"userCount"];
         }
         [reader close];
     }];
     return paramDic;
...
- (NSArray *)qimDB_selectUserWearMedalStatusByUserid:(NSString *)userId {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:paramDic setObject:status forKey:@"status"];
            [STDataMgr safeSaveForDic:paramDic setObject:userId forKey:@"medalUserId"];
            [STDataMgr safeSaveForDic:paramDic setObject:userHost forKey:@"medalUserHost"];
            [STDataMgr safeSaveForDic:paramDic setObject:medalStatus forKey:@"medalUserStatus"];
            [STDataMgr safeSaveForDic:paramDic setObject:userCount forKey:@"userCount"];
...
- (NSArray *)qimDB_getUsersInMedal:(NSInteger)medalId withLimit:(NSInteger)limit withOffset:(NSInteger)offset {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase * _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            NSMutableDictionary *paramDic = [[NSMutableDictionary alloc] init];
            [STDataMgr safeSaveForDic:paramDic setObject:userId forKey:@"UserId"];
            [STDataMgr safeSaveForDic:paramDic setObject:xmppId forKey:@"XmppId"];
            [STDataMgr safeSaveForDic:paramDic setObject:userName forKey:@"Name"];
            [STDataMgr safeSaveForDic:paramDic setObject:DescInfo forKey:@"DescInfo"];
            [STDataMgr safeSaveForDic:paramDic setObject:headersrc forKey:@"HeaderSrc"];
            [resultList addObject:paramDic];
        }
    }];
    return resultList;
