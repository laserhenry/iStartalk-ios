...
@implementation STDataMgr (WorkFeed)
...
- (NSDictionary *)qimDB_getWorkMomentWithMomentId:(NSString *)momentId {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        if ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:result setObject:rid forKey:@"id"];
            [STDataMgr safeSaveForDic:result setObject:uuid forKey:@"uuid"];
            [STDataMgr safeSaveForDic:result setObject:owner forKey:@"owner"];
            [STDataMgr safeSaveForDic:result setObject:ownerHost forKey:@"ownerHost"];
            [STDataMgr safeSaveForDic:result setObject:isAnonymous forKey:@"isAnonymous"];
            [STDataMgr safeSaveForDic:result setObject:anonymousName forKey:@"anonymousName"];
            [STDataMgr safeSaveForDic:result setObject:anonymousPhoto forKey:@"anonymousPhoto"];
            [STDataMgr safeSaveForDic:result setObject:createTime forKey:@"createTime"];
            [STDataMgr safeSaveForDic:result setObject:updateTime forKey:@"updateTime"];
            [STDataMgr safeSaveForDic:result setObject:content forKey:@"content"];
            [STDataMgr safeSaveForDic:result setObject:atList forKey:@"atList"];
            [STDataMgr safeSaveForDic:result setObject:isDelete forKey:@"isDelete"];
            [STDataMgr safeSaveForDic:result setObject:isLike forKey:@"isLike"];
            [STDataMgr safeSaveForDic:result setObject:likeNum forKey:@"likeNum"];
            [STDataMgr safeSaveForDic:result setObject:commentsNum forKey:@"commentsNum"];
            [STDataMgr safeSaveForDic:result setObject:review_status forKey:@"review_status"];
            [STDataMgr safeSaveForDic:result setObject:attachCommentList forKey:@"attachCommentList"];
        }
        [reader close];
    }];
    return result;
...
- (NSArray *)qimDB_getWorkMomentWithXmppId:(NSString *)xmppId WithLimit:(int)limit WithOffset:(int)offset {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            NSMutableDictionary *msgDic = [[NSMutableDictionary alloc] init];
            [STDataMgr safeSaveForDic:msgDic setObject:rid forKey:@"id"];
            [STDataMgr safeSaveForDic:msgDic setObject:uuid forKey:@"uuid"];
            [STDataMgr safeSaveForDic:msgDic setObject:owner forKey:@"owner"];
            [STDataMgr safeSaveForDic:msgDic setObject:ownerHost forKey:@"ownerHost"];
            [STDataMgr safeSaveForDic:msgDic setObject:isAnonymous forKey:@"isAnonymous"];
            [STDataMgr safeSaveForDic:msgDic setObject:anonymousName forKey:@"anonymousName"];
            [STDataMgr safeSaveForDic:msgDic setObject:anonymousPhoto forKey:@"anonymousPhoto"];
            [STDataMgr safeSaveForDic:msgDic setObject:createTime forKey:@"createTime"];
            [STDataMgr safeSaveForDic:msgDic setObject:updateTime forKey:@"updateTime"];
            [STDataMgr safeSaveForDic:msgDic setObject:content forKey:@"content"];
            [STDataMgr safeSaveForDic:msgDic setObject:atList forKey:@"atList"];
            [STDataMgr safeSaveForDic:msgDic setObject:isDelete forKey:@"isDelete"];
            [STDataMgr safeSaveForDic:msgDic setObject:isLike forKey:@"isLike"];
            [STDataMgr safeSaveForDic:msgDic setObject:likeNum forKey:@"likeNum"];
            [STDataMgr safeSaveForDic:msgDic setObject:commentsNum forKey:@"commentsNum"];
            [STDataMgr safeSaveForDic:msgDic setObject:review_status forKey:@"review_status"];
            [STDataMgr safeSaveForDic:msgDic setObject:attachCommentList forKey:@"attachCommentList"];
...
- (void)qimDB_bulkinsertComments:(NSArray *)comments {
    ...
    [[self dbInstance] syncUsingTransaction:^(QIMDataBase* _Nonnull database, BOOL * _Nonnull rollback) {
        ...
        for (NSDictionary *commentDic in comments) {
            ...
            [STDataMgr safeSaveForDic:newChildDic setObject:newChild forKey:commentUUID];
...
- (NSArray *)qimDB_getWorkCommentsWithMomentId:(NSString *)momentId WithLimit:(int)limit WithOffset:(int)offset {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:msgDic setObject:anonymousName forKey:@"anonymousName"];
            [STDataMgr safeSaveForDic:msgDic setObject:anonymousPhoto forKey:@"anonymousPhoto"];
            [STDataMgr safeSaveForDic:msgDic setObject:commentUUID forKey:@"commentUUID"];
            [STDataMgr safeSaveForDic:msgDic setObject:content forKey:@"content"];
            [STDataMgr safeSaveForDic:msgDic setObject:createTime forKey:@"createTime"];
            [STDataMgr safeSaveForDic:msgDic setObject:fromHost forKey:@"fromHost"];
            [STDataMgr safeSaveForDic:msgDic setObject:fromUser forKey:@"fromUser"];
            [STDataMgr safeSaveForDic:msgDic setObject:rid forKey:@"rid"];
            
            [STDataMgr safeSaveForDic:msgDic setObject:isAnonymous forKey:@"isAnonymous"];
            [STDataMgr safeSaveForDic:msgDic setObject:isDelete forKey:@"isDelete"];
            [STDataMgr safeSaveForDic:msgDic setObject:isLike forKey:@"isLike"];
            [STDataMgr safeSaveForDic:msgDic setObject:likeNum forKey:@"likeNum"];
            [STDataMgr safeSaveForDic:msgDic setObject:parentCommentUUID forKey:@"parentCommentUUID"];
            [STDataMgr safeSaveForDic:msgDic setObject:superParentUUID forKey:@"superParentUUID"];
            [STDataMgr safeSaveForDic:msgDic setObject:postUUID forKey:@"postUUID"];
            
            [STDataMgr safeSaveForDic:msgDic setObject:reviewStatus forKey:@"reviewStatus"];
            [STDataMgr safeSaveForDic:msgDic setObject:toAnonymousName forKey:@"toAnonymousName"];
            [STDataMgr safeSaveForDic:msgDic setObject:toAnonymousPhoto forKey:@"toAnonymousPhoto"];
            [STDataMgr safeSaveForDic:msgDic setObject:toHost forKey:@"toHost"];
            [STDataMgr safeSaveForDic:msgDic setObject:toUser forKey:@"toUser"];
            [STDataMgr safeSaveForDic:msgDic setObject:toisAnonymous forKey:@"toisAnonymous"];
            [STDataMgr safeSaveForDic:msgDic setObject:updateTime forKey:@"updateTime"];
            [STDataMgr safeSaveForDic:msgDic setObject:atList forKey:@"atList"];
...
- (NSArray *)qimDB_getWorkChildCommentsWithParentComments:(NSArray *)comments {
    ...
    for (NSInteger i = 0; i < comments.count; i++) {
        ...
        [STDataMgr safeSaveForDic:parentCommentDic setObject:childComments forKey:@"newChild"];
...
- (NSArray *)qimDB_getWorkNoticeMessagesWithLimit:(int)limit WithOffset:(int)offset eventTypes:(NSArray *)eventTypes readState:(int)readState {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            NSMutableDictionary *msgDic = [[NSMutableDictionary alloc] init];
            [STDataMgr safeSaveForDic:msgDic setObject:userFrom forKey:@"userFrom"];
            [STDataMgr safeSaveForDic:msgDic setObject:readState forKey:@"readState"];
            [STDataMgr safeSaveForDic:msgDic setObject:postUUID forKey:@"postUUID"];
            [STDataMgr safeSaveForDic:msgDic setObject:fromIsAnonymous forKey:@"fromIsAnonymous"];
            [STDataMgr safeSaveForDic:msgDic setObject:toIsAnonymous forKey:@"toIsAnonymous"];
            [STDataMgr safeSaveForDic:msgDic setObject:eventType forKey:@"eventType"];
            [STDataMgr safeSaveForDic:msgDic setObject:fromAnonymousPhoto forKey:@"fromAnonymousPhoto"];
            [STDataMgr safeSaveForDic:msgDic setObject:userTo forKey:@"userTo"];
            
            [STDataMgr safeSaveForDic:msgDic setObject:uuid forKey:@"uuid"];
            [STDataMgr safeSaveForDic:msgDic setObject:content forKey:@"content"];
            [STDataMgr safeSaveForDic:msgDic setObject:userToHost forKey:@"userToHost"];
            [STDataMgr safeSaveForDic:msgDic setObject:createTime forKey:@"createTime"];
            [STDataMgr safeSaveForDic:msgDic setObject:userFromHost forKey:@"userFromHost"];
            [STDataMgr safeSaveForDic:msgDic setObject:fromAnonymousName forKey:@"fromAnonymousName"];
            [STDataMgr safeSaveForDic:msgDic setObject:toAnonymousName forKey:@"toAnonymousName"];
            [STDataMgr safeSaveForDic:msgDic setObject:toAnonymousPhoto forKey:@"toAnonymousPhoto"];
