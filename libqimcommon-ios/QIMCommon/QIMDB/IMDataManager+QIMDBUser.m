...
@implementation STDataMgr (QIMDBUser)
...
- (void)qimDB_bulkInsertOrgansUserInfos:(NSArray *)userInfos {
    [[self dbInstance] syncUsingTransaction:^(QIMDataBase* _Nonnull database, BOOL * _Nonnull rollback) {
        ...
        for (NSDictionary *infoDic in userInfos) {
            ...
            NSString *xmppId = [NSString stringWithFormat:@"%@@%@",userId, [[STDataMgr qimDB_SharedInstance] getDBOwnerDomain]];
...
- (NSDictionary *)qimDB_selectUserByJID:(NSString *)jid{
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        if ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:user setObject:mood forKey:@"Mood"];
            [STDataMgr safeSaveForDic:user setObject:sex forKey:@"Sex"];
        }
        [reader close];
    }];
    return user;
...
- (NSDictionary *)qimDB_selectUserBackInfoByXmppId:(NSString *)xmppId {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        if ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:userBackInfo setObject:workInfo forKey:@"UserWorkInfo"];
            [STDataMgr safeSaveForDic:userBackInfo setObject:dateTime forKey:@"LastUpdateTime"];
        }
        [reader close];
    }];
    return userBackInfo;
...
- (NSArray *)qimDB_getOrganUserList {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:user setObject:headerSrc forKey:@"HeaderSrc"];
            [STDataMgr safeSaveForDic:user setObject:searchIndex forKey:@"SearchIndex"];
            [STDataMgr safeSaveForDic:user setObject:UserInfo forKey:@"UserInfo"];
            [STDataMgr safeSaveForDic:user setObject:mood forKey:@"Mood"];
            [STDataMgr safeSaveForDic:user setObject:dateTime forKey:@"LastUpdateTime"];
            [STDataMgr safeSaveForDic:user setObject:visibleFlag forKey:@"visibleFlag"];
...
- (NSArray *)qimDB_selectUserListBySearchStr:(NSString *)searchStr inGroup:(NSString *) groupId {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:dic setObject:userId forKey:@"UserId"];
            [STDataMgr safeSaveForDic:dic setObject:xmppId forKey:@"XmppId"];
            [STDataMgr safeSaveForDic:dic setObject:name forKey:@"Name"];
            [STDataMgr safeSaveForDic:dic setObject:descInfo forKey:@"DescInfo"];
...
- (NSDictionary *)qimDB_selectUsersDicByXmppIds:(NSArray *)xmppIds{
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:dic setObject:descInfo forKey:@"DescInfo"];
            [STDataMgr safeSaveForDic:dic setObject:headerSrc forKey:@"HeaderSrc"];
            [STDataMgr safeSaveForDic:dic setObject:userInfo forKey:@"UserInfo"];
            [STDataMgr safeSaveForDic:dic setObject:lastUpdateTime forKey:@"LastUpdateTime"];
            [STDataMgr safeSaveForDic:dic setObject:searchIndex forKey:@"SearchIndex"];
            [STDataMgr safeSaveForDic:dic setObject:sex forKey:@"Sex"];
