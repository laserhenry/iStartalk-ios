...
@implementation STDataMgr (QIMDBClientConfig)
...
//            }
            ...
            [STDataMgr safeSaveForDic:value setObject:userId forKey:@"userId"];
            [STDataMgr safeSaveForDic:value setObject:xmppid forKey:@"XmppId"];
            [STDataMgr safeSaveForDic:value setObject:nickName forKey:@"Name"];
            [STDataMgr safeSaveForDic:value setObject:headUrl forKey:@"HeaderUri"];
