...
@implementation STDataMgr (QIMDBCollectionMessage)
...
- (NSArray *)qimDB_getCollectionAccountList {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:value setObject:bindId forKey:@"BindId"];
            [STDataMgr safeSaveForDic:value setObject:bindName forKey:@"BindName"];
...
- (NSDictionary *)qimDB_selectCollectionUserByJID:(NSString *)jid{
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        if ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:user setObject:userId forKey:@"UserId"];
            [STDataMgr safeSaveForDic:user setObject:XmppId forKey:@"XmppId"];
            [STDataMgr safeSaveForDic:user setObject:name?name:userId forKey:@"Name"];
            [STDataMgr safeSaveForDic:user setObject:descInfo forKey:@"DescInfo"];
            [STDataMgr safeSaveForDic:user setObject:headerSrc forKey:@"HeaderSrc"];
            [STDataMgr safeSaveForDic:user setObject:data forKey:@"UserInfo"];
            [STDataMgr safeSaveForDic:user setObject:dateTime forKey:@"LastUpdateTime"];
            [STDataMgr safeSaveForDic:user setObject:searchIndex forKey:@"SearchIndex"];
        }
        [reader close];
    }];
    QIMVerboseLog(@"");
...
- (NSDictionary *)qimDB_getCollectionGroupCardByGroupId:(NSString *)groupId{
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        if ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:groupCardDic setObject:groupId forKey:@"GroupId"];
            [STDataMgr safeSaveForDic:groupCardDic setObject:name forKey:@"Name"];
            [STDataMgr safeSaveForDic:groupCardDic setObject:introduce forKey:@"Introduce"];
            [STDataMgr safeSaveForDic:groupCardDic setObject:headerSrc forKey:@"HeaderSrc"];
            [STDataMgr safeSaveForDic:groupCardDic setObject:topic forKey:@"Topic"];
            [STDataMgr safeSaveForDic:groupCardDic setObject:lastUpdateTime forKey:@"LastUpdateTime"];
        }
        [reader close];
    }];
    QIMVerboseLog(@"");
...
- (NSDictionary *)qimDB_getLastCollectionMsgWithLastMsgId:(NSString *)lastMsgId {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        if ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:resultDic setObject:originFrom forKey:@"Originfrom"];
            [STDataMgr safeSaveForDic:resultDic setObject:chatType forKey:@"ChatType"];
            [STDataMgr safeSaveForDic:resultDic setObject:content forKey:@"Content"];
        }
        [reader close];
    }];
    QIMVerboseLog(@"");
...
- (NSArray *)qimDB_getCollectionSessionListWithBindId:(NSString *)bindId {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:sessionDic setObject:OriginFrom forKey:@"XmppId"];
            [STDataMgr safeSaveForDic:sessionDic setObject:OriginFrom forKey:@"UserId"];
            ...
            [STDataMgr safeSaveForDic:sessionDic setObject:msgId forKey:@"LastMsgId"];
            ...
            [STDataMgr safeSaveForDic:sessionDic setObject:@(QIMMessageSendState_Success) forKey:@"MsgState"];
            [STDataMgr safeSaveForDic:sessionDic setObject:@(QIMMessageDirection_Received) forKey:@"MsgDirection"];
            [STDataMgr safeSaveForDic:sessionDic setObject:LastUpdateTime forKey:@"MsgDateTime"];
...
- (NSArray *)qimDB_getCollectionMsgListWithBindId:(NSString *)bindId {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:msgDic setObject:msgId forKey:@"MsgId"];
            [STDataMgr safeSaveForDic:msgDic setObject:from forKey:@"From"];
            [STDataMgr safeSaveForDic:msgDic setObject:to forKey:@"To"];
            [STDataMgr safeSaveForDic:msgDic setObject:content forKey:@"Content"];
            [STDataMgr safeSaveForDic:msgDic setObject:platform forKey:@"Platform"];
            [STDataMgr safeSaveForDic:msgDic setObject:msgType forKey:@"MsgType"];
            [STDataMgr safeSaveForDic:msgDic setObject:msgState forKey:@"MsgState"];
            [STDataMgr safeSaveForDic:msgDic setObject:msgDirection forKey:@"MsgDirection"];
            [STDataMgr safeSaveForDic:msgDic setObject:msgDateTime forKey:@"MsgDateTime"];
            [STDataMgr safeSaveForDic:msgDic setObject:extendInfo forKey:@"ExtendInfo"];
...
- (NSDictionary *)qimDB_getCollectionMsgListForMsgId:(NSString *)msgId {
    ...
    [[self dbInstance] inDatabase:^(QIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [STDataMgr safeSaveForDic:msgDic setObject:msgId forKey:@"MsgId"];
            [STDataMgr safeSaveForDic:msgDic setObject:originfrom forKey:@"OriginFrom"];
            [STDataMgr safeSaveForDic:msgDic setObject:originto forKey:@"OriginTo"];
            [STDataMgr safeSaveForDic:msgDic setObject:originChatType forKey:@"OriginChatType"];
            [STDataMgr safeSaveForDic:msgDic setObject:xmppId forKey:@"XmppId"];
            [STDataMgr safeSaveForDic:msgDic setObject:platform forKey:@"Platform"];
            [STDataMgr safeSaveForDic:msgDic setObject:from forKey:@"From"];
            [STDataMgr safeSaveForDic:msgDic setObject:to forKey:@"To"];
            [STDataMgr safeSaveForDic:msgDic setObject:content forKey:@"Content"];
            [STDataMgr safeSaveForDic:msgDic setObject:extendInfo forKey:@"ExtendInfo"];
            [STDataMgr safeSaveForDic:msgDic setObject:msgType forKey:@"MsgType"];
            [STDataMgr safeSaveForDic:msgDic setObject:state forKey:@"MsgState"];
            [STDataMgr safeSaveForDic:msgDic setObject:direction forKey:@"MsgDirection"];
            [STDataMgr safeSaveForDic:msgDic setObject:contentResolve forKey:@"ContentResolve"];
            [STDataMgr safeSaveForDic:msgDic setObject:readState forKey:@"ReadState"];
            [STDataMgr safeSaveForDic:msgDic setObject:msgDateTime forKey:@"MsgDateTime"];
            [STDataMgr safeSaveForDic:msgDic setObject:messageRaw forKey:@"MessageRaw"];
            [STDataMgr safeSaveForDic:msgDic setObject:realJid forKey:@"RealJid"];
        }
    }];
    QIMVerboseLog(@"");
    return msgDic;
