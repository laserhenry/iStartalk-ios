...
@interface STUserCacheManager () <NSCacheDelegate>
...
@implementation STUserCacheManager {
...
+ (instancetype)sharedInstance {
    static STUserCacheManager *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[STUserCacheManager alloc] init];
    });
    return instance;
}
