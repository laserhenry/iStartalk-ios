...
+ (void)updateGroupListToKeyChain {
    NSData *groupListStr = [[QIMJSONSerializer sharedInstance] serializeObject:[[STDataMgr qimDB_SharedInstance] qimDB_getGroupList] error:nil];
    [QIMUUIDTools setUUIDToolsMyGroupList:groupListStr];
}

+ (void)updateFriendListToKeyChain {
    //save friend list to keychain
    NSArray *dbFriendList = [[STDataMgr qimDB_SharedInstance] qimDB_selectFriendList];
