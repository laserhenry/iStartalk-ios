...
- (void)dealWithQuickReplyRemoteData:(NSDictionary *)data {
    ...
    if (groupInfo.count > 0) {
        ...
        [[STDataMgr qimDB_SharedInstance] qimDB_bulkInsertQuickReply:updateGroupItems];
        [[STDataMgr qimDB_SharedInstance] qimDB_deleteQuickReplyGroup:deleteGroupItems];
    }
    ...
    if (contentInfo.count > 0) {
        ...
        [[STDataMgr qimDB_SharedInstance] qimDB_bulkInsertQuickReplyContents:updateContentItems];
        [[STDataMgr qimDB_SharedInstance] qimDB_deleteQuickReplyContents:deleteContentItems];
    }
}

- (NSInteger)getQuickReplyGroupCount {
    return [[STDataMgr qimDB_SharedInstance] qimDB_getQuickReplyGroupCount];
}

- (NSArray *)getQuickReplyGroup {
    return [[STDataMgr qimDB_SharedInstance] qimDB_getQuickReplyGroup];
}

- (NSArray *)getQuickReplyContentWithGroupId:(long)groupId {
    return [[STDataMgr qimDB_SharedInstance] qimDB_getQuickReplyContentWithGroupId:groupId];
}
