...
- (void)updateFriendList {
    ...
    }
    {
        ...
        NSDictionary *friendDic = [[STDataMgr qimDB_SharedInstance] qimDB_selectUsersDicByXmppIds:xmppIds];
        ...
        if (updateList.count > 0) {
            [[STDataMgr qimDB_SharedInstance] qimDB_bulkInsertFriendList:updateList];
        } else {
...
- (void)agreeFriendRequestWithXmppId:(NSString *)xmppId {
    ...
    [[STDataMgr qimDB_SharedInstance] qimDB_updateFriendNotifyWithXmppId:xmppId WithState:1];
}

- (void)refusedFriendRequestWithXmppId:(NSString *)xmppId {
    
    [[XmppImManager sharedInstance] refusedFriendRequestWithXmppId:xmppId];
    [[STDataMgr qimDB_SharedInstance] qimDB_updateFriendNotifyWithXmppId:xmppId WithState:2];
}
                ...
                if (errCode == 0) {
                    ...
                    if ([resultArray isKindOfClass:[NSArray class]]) {
                        ...
                        if ([[STAppInfo sharedInstance] appType] != QIMProjectTypeQChat) {
                            ...
                            NSArray *list = [[STDataMgr qimDB_SharedInstance] qimDB_selectUserListByUserIds:userIds];
                            ...
                            [[STDataMgr qimDB_SharedInstance] qimDB_bulkInsertFriendNotifyList:list];
                            ...
                            for (NSString *userID in userIds) {
                                ...
                                NSDictionary *userInfoD = [[STDataMgr qimDB_SharedInstance] qimDB_selectUserByJID:userID];
                                if (userInfoD == nil) {
                                    
                                    userInfoD = [[STDataMgr qimDB_SharedInstance] qimDB_selectUserByJID:[NSString stringWithFormat:@"%@@%@", userID, [self getDomain]]];
                                }
                            ...
                            [[STDataMgr qimDB_SharedInstance] qimDB_bulkInsertFriendNotifyList:userList];
                        }
...
- (NSDictionary *)getLastFriendNotify {
    return nil;
    return [[STDataMgr qimDB_SharedInstance] qimDB_getLastFriendNotify];
}

- (NSInteger)getFriendNotifyCount {
    return 0;
    return [[STDataMgr qimDB_SharedInstance] qimDB_getFriendNotifyCount];
}
