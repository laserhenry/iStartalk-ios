...
- (NSArray *)getLocalSearchKeyHistoryWithSearchType:(NSInteger)searchType withLimit:(NSInteger)limit {
    NSArray *array = [[STDataMgr qimDB_SharedInstance] qimDB_getLocalSearchKeyHistoryWithSearchType:searchType withLimit:5];
    return array;
}

- (void)updateLocalSearchKeyHistory:(NSDictionary *)searchDic {
    [[STDataMgr qimDB_SharedInstance] qimDB_updateLocalSearchKeyHistory:searchDic];
}

- (void)deleteSearchKeyHistoryWithSearchType:(NSInteger)searchType {
    [[STDataMgr qimDB_SharedInstance] qimDB_deleteSearchKeyHistoryWithSearchType:searchType];
}

- (void)deleteSearchKeyHistory {
    [[STDataMgr qimDB_SharedInstance] qimDB_deleteSearchKeyHistory];
}
