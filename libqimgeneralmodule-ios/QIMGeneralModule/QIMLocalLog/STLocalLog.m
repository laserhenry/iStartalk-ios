...
- (void)sendFeedBackWithLogFileUrl:(NSString *)logFileUrl WithContent:(NSString *)content withUserInitiative:(BOOL)initiative {
    NSString *title = [NSString stringWithFormat:@"【IOS】来自：%@的反馈日志", [[STKit sharedInstance] getLastJid]];
    ...
    NSString *eventName = [NSString stringWithFormat:@"反馈内容：%@\n平台：%@\n用户ID：%@\n导航地址: %@\n日志地址 : %@\n设备信息：%@\n设备系统版本：%@\nApp版本:%@", content, platName, [[STKit sharedInstance] getLastJid], [oldNavConfigUrlDict objectForKey:QIMNavUrlKey], logFileUrl, [[[STKit sharedInstance] deviceName] stringByReplacingOccurrencesOfString:@" " withString:@""], systemVersion, appVersion];
