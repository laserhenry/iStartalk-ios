...
- (void)beginEncryptChat:(NSNotification *)notify {
    ...
    NSDictionary *userInfo = [[STKit sharedInstance] getUserInfoByUserId:self.userId];
    ...
    [[STKit sharedInstance] createMessageWithMsg:@"对方发起加密会话请求" extenddInfo:nil userId:notify.object realJid:nil userType:ChatType_SingleChat msgType:QIMMessageType_Time forMsgId:[QIMUUIDTools UUID] msgState:QIMMessageSendState_Success willSave:YES];
...
- (void)agreeEncryptChat:(NSNotification *)notify {
    ...
    if (carbon == YES) {
        ...
        [[STKit sharedInstance] createMessageWithMsg:@"已在其他设备同意加密会话请求" extenddInfo:nil userId:notify.object realJid:nil userType:ChatType_SingleChat msgType:QIMMessageType_Time forMsgId:[QIMUUIDTools UUID] msgState:QIMMessageSendState_Success willSave:YES];
        [self handleEncryptWithUserId:notify.object WithState:QIMEncryptChatStateNone];
    } else {
        [[STKit sharedInstance] createMessageWithMsg:@"对方同意加密会话请求" extenddInfo:nil userId:notify.object realJid:nil userType:ChatType_SingleChat msgType:QIMMessageType_Time forMsgId:[QIMUUIDTools UUID] msgState:QIMMessageSendState_Success willSave:YES];
...
- (void)refuseEncryptChat:(NSNotification *)notify {
    ...
    if (carbon == YES) {
        ...
        [[STKit sharedInstance] createMessageWithMsg:@"已在其他设备拒绝加密会话请求" extenddInfo:nil userId:notify.object realJid:nil userType:ChatType_SingleChat msgType:QIMMessageType_Time forMsgId:[QIMUUIDTools UUID] msgState:QIMMessageSendState_Success willSave:YES];
        [self handleEncryptWithUserId:notify.object WithState:QIMEncryptChatStateNone];
    } else {
        [[STKit sharedInstance] createMessageWithMsg:@"对方拒绝加密会话请求" extenddInfo:nil userId:notify.object realJid:nil userType:ChatType_SingleChat msgType:QIMMessageType_Time forMsgId:[QIMUUIDTools UUID] msgState:QIMMessageSendState_Success willSave:YES];
        [self handleEncryptWithUserId:notify.object WithState:QIMEncryptChatStateNone];
    }
}
...
- (void)cancelEncryptChat:(NSNotification *)notify {
    ...
    if (carbon == YES) {
        ...
        [[STKit sharedInstance] createMessageWithMsg:@"已在其他设备取消加密会话" extenddInfo:nil userId:notify.object realJid:nil userType:ChatType_SingleChat msgType:QIMMessageType_Time forMsgId:[QIMUUIDTools UUID] msgState:QIMMessageSendState_Success willSave:YES];
        [self handleEncryptWithUserId:notify.object WithState:QIMEncryptChatStateNone];
    } else {
        [[STKit sharedInstance] createMessageWithMsg:@"对方已取消加密会话" extenddInfo:nil userId:notify.object realJid:nil userType:ChatType_SingleChat msgType:QIMMessageType_Time forMsgId:[QIMUUIDTools UUID] msgState:QIMMessageSendState_Success willSave:YES];
        [self handleEncryptWithUserId:notify.object WithState:QIMEncryptChatStateNone];
    }
}
...
- (void)closeEncryptChat:(NSNotification *)notify {
    ...
    if (carbon == YES) {
        ...
        [[STKit sharedInstance] createMessageWithMsg:@"已在其他设备关闭加密会话" extenddInfo:nil userId:notify.object realJid:nil userType:ChatType_SingleChat msgType:QIMMessageType_Time forMsgId:[QIMUUIDTools UUID] msgState:QIMMessageSendState_Success willSave:YES];
        [self handleEncryptWithUserId:notify.object WithState:QIMEncryptChatStateNone];
    } else {
        [[STKit sharedInstance] createMessageWithMsg:@"对方已关闭加密会话" extenddInfo:nil userId:notify.object realJid:nil userType:ChatType_SingleChat msgType:QIMMessageType_Time forMsgId:[QIMUUIDTools UUID] msgState:QIMMessageSendState_Success willSave:YES];
        [self handleEncryptWithUserId:notify.object WithState:QIMEncryptChatStateNone];
    }
}
 ...
 */
- (void)refuseEncrypt {
    [[STKit sharedInstance] createMessageWithMsg:@"拒绝加密会话请求" extenddInfo:nil userId:self.userId realJid:nil userType:ChatType_SingleChat msgType:QIMMessageType_Time forMsgId:[QIMUUIDTools UUID] msgState:QIMMessageSendState_Success willSave:YES];
 ...
 */
- (void)cancelEncrypt {
    [[STKit sharedInstance] createMessageWithMsg:@"取消加密会话请求" extenddInfo:nil userId:self.userId realJid:nil userType:ChatType_SingleChat msgType:QIMMessageType_Time forMsgId:[QIMUUIDTools UUID] msgState:QIMMessageSendState_Success willSave:YES];
...
//关闭加密会话
- (void)closeEncrypt {
    [[STKit sharedInstance] createMessageWithMsg:@"关闭加密会话请求" extenddInfo:nil userId:self.userId realJid:nil userType:ChatType_SingleChat msgType:QIMMessageType_Time forMsgId:[QIMUUIDTools UUID] msgState:QIMMessageSendState_Success willSave:YES];
...
- (void)beginEncryptChatWithUserId:(NSString *)userId
    ...
    if (agree) {
        ...
        if (chatPwd == nil) {
            ...
            [[STKit sharedInstance] createMessageWithMsg:@"同意加密会话请求" extenddInfo:nil userId:self.userId realJid:nil userType:ChatType_SingleChat msgType:QIMMessageType_Time forMsgId:[QIMUUIDTools UUID] msgState:QIMMessageSendState_Success willSave:YES];
        ...
        if (self.willChangeState == QIMEncryptChatStateEncrypting) {
            ...
            [[STKit sharedInstance] createMessageWithMsg:@"发起加密会话请求" extenddInfo:nil userId:self.userId realJid:nil userType:ChatType_SingleChat msgType:QIMMessageType_Time forMsgId:[QIMUUIDTools UUID] msgState:QIMMessageSendState_Success willSave:YES];
        } else {
            self.willChangeState = QIMEncryptChatStateNone;
    ...
    if (userId) {
        ...
        if (leftTime <= 0 && leftTime > [NSDate timeIntervalSinceReferenceDate]) {
            ...
            if (securitySettingTime == 0) {
                ...
                securitySettingTime = [[[STKit sharedInstance] userObjectForKey:@"securityMinute"] integerValue];
            }
...
- (NSInteger)getMessageTypeWithEncryptMsg:(STMsgModel *)msg WithUserId:(NSString *)userId {
...
- (NSString *)getMessageBodyWithEncryptMsg:(STMsgModel *)msg WithUserId:(NSString *)userId {
    NSDictionary *deMessage = [self decryptMessageWithMsgType:msg WithUserId:userId];
    NSString *msgBody = [deMessage objectForKey:@"Content"];
    return msgBody;
}

- (NSString *)getMessageExtendInfoWithEncryptMsg:(STMsgModel *)msg WithUserId:(NSString *)userId {
    NSDictionary *deMessage = [self decryptMessageWithMsgType:msg WithUserId:userId];
    NSString *msgExtendInfo = [deMessage objectForKey:@"ExtendInfo"];
    return msgExtendInfo;
}

- (NSDictionary *)decryptMessageWithMsgType:(STMsgModel *)msg WithUserId:(NSString *)userId {
