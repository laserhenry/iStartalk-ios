...
- (instancetype)init {
    self = [super init];
    if (self) {
        self.baseUrl = [[STKit sharedInstance] qimNav_QCloudHost];
        if (self.baseUrl.length <= 0) {
            self.baseUrl = @"https://qim.qunar.com/package/qtapi/qcloud/";
        }
        self.passwordVersion = [[[STKit sharedInstance] userObjectForKey:@"passwordVerison"] integerValue];
...
- (void)saveNewQTNoteMainItem:(QIMNoteModel *)model {
    ...
    [[STKit sharedInstance] insertQTNotesMainItemWithQId:model.q_id WithCid:model.c_id WithQType:model.q_type WithQTitle:model.q_title WithQIntroduce:model.q_introduce WithQContent:model.q_content WithQTime:model.q_time WithQState:model.q_state WithQExtendedFlag:QIMNoteExtendedFlagStateLocalCreated];
...
- (void)updateQTNoteMainItemWithModel:(QIMNoteModel *)model {
    ...
    [[STKit sharedInstance] updateToMainWithQId:model.q_id WithCid:model.c_id WithQType:model.q_type WithQTitle:model.q_title WithQDescInfo:model.q_introduce WithQContent:model.q_content WithQTime:model.q_time WithQState:model.q_state WithQExtendedFlag:exFlagState];
...
- (void)updateQTNoteMainItemStateWithModel:(QIMNoteModel *)model {
    ...
    [[STKit sharedInstance] updateMainStateWithQid:model.q_id WithCid:model.c_id WithQState:model.q_state WithQExtendedFlag:exFlagState];
...
- (NSArray *)getMainItemWithType:(QIMNoteType)type Keywords:(NSString *)keyWords {
    NSArray *array = [[STKit sharedInstance] getQTNotesMainItemWithQType:type QString:keyWords];
...
- (NSArray *)getMainItemWithType:(QIMNoteType)type WithExceptState:(QIMNoteState)state {
    ...
    NSArray *array = [[STKit sharedInstance] getQTNotesMainItemWithQType:type WithExceptQState:state];
    NSMutableArray *models = [NSMutableArray arrayWithCapacity:5];
    for (NSDictionary *dict in array) {
        QIMNoteModel *model = [[QIMNoteModel alloc] init];
        [model setValuesForKeysWithDictionary:dict];
...
- (NSArray *)getMainItemWithType:(QIMNoteType)type State:(QIMNoteState)state {
    ...
    NSArray *array = [[STKit sharedInstance] getQTNotesMainItemWithQType:type WithQState:state];
    NSMutableArray *models = [NSMutableArray arrayWithCapacity:5];
    for (NSDictionary *dict in array) {
        QIMNoteModel *model = [[QIMNoteModel alloc] init];
        [model setValuesForKeysWithDictionary:dict];
...
- (NSArray *)getMainItemWithQExtendedFlag:(QIMNoteExtendedFlagState)qExtendedFlag {
    NSArray *array = [[STKit sharedInstance] getQTNotesMainItemWithQExtendFlag:qExtendedFlag];
    NSMutableArray *models = [NSMutableArray arrayWithCapacity:5];
    for (NSDictionary *dict in array) {
        QIMNoteModel *model = [[QIMNoteModel alloc] init];
        [model setValuesForKeysWithDictionary:dict];
...
- (NSInteger)getMaxQTNoteMainItemCid {
    return [[STKit sharedInstance] getMaxQTNoteMainItemCid];
}

- (NSInteger)getQTNoteMainItemMaxTimeWithType:(QIMNoteType)type {
    return [[STKit sharedInstance] getQTNoteMainItemMaxTimeWithQType:type];
}

- (NSInteger)getQTNoteSubItemMaxTimeWitModel:(QIMNoteModel *)model {
    return [[STKit sharedInstance] getQTNoteSubItemMaxTimeWithCid:model.c_id WithQSType:model.q_type];
}

- (NSArray *)getTodoListItemWithCompleteState:(NSString *)completeState {
    NSArray *array = [[STKit sharedInstance] getQTNoteMainItemWithQType:QIMNoteTypeTodoList WithQDescInfo:completeState];
    NSMutableArray *models = [NSMutableArray arrayWithCapacity:5];
    for (NSDictionary *dict in array) {
        QIMNoteModel *model = [[QIMNoteModel alloc] init];
        [model setValuesForKeysWithDictionary:dict];
...
- (void)batchSyncToRemoteMainItems {
    NSArray *needInserts = [[STKit sharedInstance] getQTNotesMainItemWithQExtendedFlag:1 needConvertToString:YES];
    NSArray *needUpdates = [[STKit sharedInstance] getQTNotesMainItemWithQExtendedFlag:2 needConvertToString:YES];
...
- (void)updateQTNoteSubItemWithQSModel:(QIMNoteModel *)model {
    ...
    [[STKit sharedInstance] updateToSubWithCid:model.c_id WithQSid:model.qs_id WithCSid:model.cs_id WithQSTitle:model.qs_title WithQSDescInfo:model.qs_introduce WithQSContent:model.qs_content WithQSTime:model.qs_time WithQSState:model.qs_state WithQS_ExtendedFlag:exFlagState];
    [self updateToRemoteSubWithSubModel:model];
}

- (void)deleteQTNoteSubItemWithQSModel:(QIMNoteModel *)model {
    
    [[STKit sharedInstance] deleteToSubWithCSId:model.cs_id];
...
- (void)updateQTNoteSubItemStateWithQSModel:(QIMNoteModel *)model {
    ...
    [[STKit sharedInstance] updateSubStateWithCSId:model.cs_id WithQSState:model.qs_state WithQsExtendedFlag:exFlagState] ;
...
- (NSArray *)getSubItemWithCid:(NSInteger)cid WithQSExtendedFlag:(QIMNoteExtendedFlagState)qsExtendedFlag {
    NSArray *array = [[STKit sharedInstance] getQTNotesSubItemWithCid:cid QSExtendedFlag:qsExtendedFlag];
    NSMutableArray *models = [NSMutableArray arrayWithCapacity:5];
    for (NSDictionary *dict in array) {
        QIMNoteModel *model = [[QIMNoteModel alloc] init];
        [model setValuesForKeysWithDictionary:dict];
...
- (NSArray *)getSubItemWithCid:(NSInteger)cid WithType:(QIMNoteType)type WithQState:(QIMNoteState)state {
    NSArray *array = [[STKit sharedInstance] getQTNotesSubItemWithCid:cid WithQSType:type WithQSState:state];
    NSMutableArray *models = [NSMutableArray arrayWithCapacity:5];
    for (NSDictionary *dict in array) {
        QIMNoteModel *model = [[QIMNoteModel alloc] init];
        [model setValuesForKeysWithDictionary:dict];
...
- (NSArray *)getSubItemWithCid:(NSInteger)cid WithType:(QIMNoteType)type WithExpectState:(QIMNoteState)state {
    NSArray *array = [[STKit sharedInstance] getQTNotesSubItemWithCid:cid WithQSType:type WithExpectQSState:state];
    NSMutableArray *models = [NSMutableArray arrayWithCapacity:5];
    for (NSDictionary *dict in array) {
        QIMNoteModel *model = [[QIMNoteModel alloc] init];
        [model setValuesForKeysWithDictionary:dict];
...
- (NSArray *)getSubItemWithCid:(NSInteger)cid WithState:(QIMNoteState)state{
    NSArray *array = [[STKit sharedInstance] getQTNotesSubItemWithCid:cid WithQSState:state];
    NSMutableArray *models = [NSMutableArray arrayWithCapacity:5];
    for (NSDictionary *dict in array) {
        QIMNoteModel *model = [[QIMNoteModel alloc] init];
        [model setValuesForKeysWithDictionary:dict];
...
- (NSArray *)getSubItemWithCid:(NSInteger)cid WithExpectState:(QIMNoteState)state{
    NSArray *array = [[STKit sharedInstance] getQTNotesSubItemWithCid:cid WithExpectQSState:state];
    NSMutableArray *models = [NSMutableArray arrayWithCapacity:5];
    for (NSDictionary *dict in array) {
        QIMNoteModel *model = [[QIMNoteModel alloc] init];
        [model setValuesForKeysWithDictionary:dict];
...
- (NSArray *)getSubItemWithState:(QIMNoteState)state {
    ...
    NSArray *array = [[STKit sharedInstance] getQTNotesSubItemWithQSState:state];
    NSMutableArray *models = [NSMutableArray arrayWithCapacity:5];
    for (NSDictionary *dict in array) {
        QIMNoteModel *model = [[QIMNoteModel alloc] init];
        [model setValuesForKeysWithDictionary:dict];
...
- (NSArray *)getSubItemWithExpectState:(QIMNoteState)state {
    ...
    NSArray *array = [[STKit sharedInstance] getQTNotesSubItemWithExpectQSState:state];
    NSMutableArray *models = [NSMutableArray arrayWithCapacity:5];
    for (NSDictionary *dict in array) {
        QIMNoteModel *model = [[QIMNoteModel alloc] init];
        [model setValuesForKeysWithDictionary:dict];
...
- (QIMNoteModel *)getQTNoteSubItemWithParmDict:(NSDictionary *)paramDict {
    NSDictionary *subModelDict = [[STKit sharedInstance] getQTNoteSubItemWithParmDict:paramDict];
...
- (NSInteger)getMaxQTNoteSubItemCSid {
    return [[STKit sharedInstance] getMaxQTNoteSubItemCSid];
}

- (void)batchSyncToRemoteSubItemsWithMainQid:(NSString *)qid {
    NSArray *needInserts = [[STKit sharedInstance] getQTNotesSubItemWithMainQid:qid WithQSExtendedFlag:QIMNoteExtendedFlagStateLocalCreated needConvertToString:YES];
    NSArray *needUpdates = [[STKit sharedInstance] getQTNotesSubItemWithMainQid:qid WithQSExtendedFlag:QIMNoteExtendedFlagStateLocalModify needConvertToString:YES];
...
- (NSMutableDictionary *)requestHeaders {
    ...
    NSString *requesTHeaders = [NSString stringWithFormat:@"p_user=%@;q_ckey=%@", [STKit getLastUserName], [[STKit sharedInstance] thirdpartKeywithValue]];
...
- (void)saveToRemoteMainWithMainItem:(QIMNoteModel *)model {
    ...
    [[STKit sharedInstance] sendTPPOSTRequestWithUrl:urlStr withRequestBodyData:data withSuccessCallBack:^(NSData *responseData) {
        ...
        if ([infoDic objectForKey:@"ret"] && [[infoDic objectForKey:@"errcode"] integerValue] == 0) {
            ...
            if (data && ![data isKindOfClass:[NSNull class]]) {
                ...
                [[STKit sharedInstance] updateToMainWithQId:qid WithCid:model.c_id WithQType:type WithQTitle:title WithQDescInfo:desc WithQContent:content WithQTime:version WithQState:model.q_state WithQExtendedFlag:QIMNoteExtendedFlagStateRemoteUpdated];
            }
        }
    ...
    [[STKit sharedInstance] sendTPPOSTRequestWithUrl:urlStr withRequestBodyData:data withSuccessCallBack:^(NSData *responseData) {
        ...
        if ([[infoDic objectForKey:@"ret"] integerValue] && [[infoDic objectForKey:@"errcode"] integerValue] == 0) {
            ...
            if (data && ![data isKindOfClass:[NSNull class]]) {
                ...
                [[STKit sharedInstance] updateToMainItemTimeWithQId:resultQid WithQTime:version WithQExtendedFlag:QIMNoteExtendedFlagStateRemoteUpdated];
            }
        }
    } withFailedCallBack:^(NSError *error) {
    ...
    [[STKit sharedInstance] sendTPPOSTRequestWithUrl:urlStr withRequestBodyData:data withSuccessCallBack:^(NSData *responseData) {
        ...
        if ([[infoDic objectForKey:@"ret"] integerValue] && [[infoDic objectForKey:@"errcode"] integerValue] == 0) {
            ...
            if (data && ![data isKindOfClass:[NSNull class]]) {
                NSInteger resultQid = [[dict objectForKey:@"qid"] integerValue];
                NSInteger version = [[dict objectForKey:@"version"] integerValue];
                [[STKit sharedInstance] deleteToMainWithQid:resultQid];
            }
        }
    } withFailedCallBack:^(NSError *error) {
        ...
        if ([[infoDic objectForKey:@"ret"] integerValue] && [[infoDic objectForKey:@"errcode"] integerValue] == 0) {
            ...
            if (data && ![data isKindOfClass:[NSNull class]]) {
                for (NSDictionary *dict in resultArray) {
                    ...
                    if ([[STKit sharedInstance] checkExitsMainItemWithQid:resultQid WithCId:0]) {
                        [[STKit sharedInstance] updateToMainWithQId:resultQid WithCid:0 WithQType:resultType WithQTitle:resultTitle WithQDescInfo:resultDesc WithQContent:resultContent WithQTime:resultVersion WithQState:resultState WithQExtendedFlag:QIMNoteExtendedFlagStateRemoteUpdated];
                    } else {
                        [[STKit sharedInstance] insertQTNotesMainItemWithQId:resultQid WithCid:0 WithQType:resultType WithQTitle:resultTitle WithQIntroduce:resultDesc WithQContent:resultContent WithQTime:resultVersion WithQState:resultState WithQExtendedFlag:QIMNoteExtendedFlagStateRemoteUpdated];
                    }
...
- (void)batchSyncToRemoteMainItemsWithInserts:(NSArray *)inserts updates:(NSArray *)updates {
    ...
    [[STKit sharedInstance] sendTPPOSTRequestWithUrl:urlStr withRequestBodyData:data withSuccessCallBack:^(NSData *responseData) {
        ...
        if ([[infoDic objectForKey:@"ret"] integerValue] && [[infoDic objectForKey:@"errcode"] integerValue] == 0) {
            NSArray *resultArray = [infoDic objectForKey:@"data"];
            if (data && ![data isKindOfClass:[NSNull class]]) {
                [[STKit sharedInstance] updateToMainItemWithDicts:resultArray];
            }
        }
    } withFailedCallBack:^(NSError *error) {
...
- (void)saveToRemoteSubWithSubModel:(QIMNoteModel *)model{
    ...
    NSDictionary *mainModelDict = [[STKit sharedInstance] getQTNotesMainItemWithCid:model.c_id];
    ...
    [[STKit sharedInstance] sendTPPOSTRequestWithUrl:urlStr withRequestBodyData:data withSuccessCallBack:^(NSData *responseData) {
        ...
        if ([[infoDic objectForKey:@"ret"] integerValue] && [[infoDic objectForKey:@"errcode"] integerValue] == 0) {
            ...
            if (data && ![data isKindOfClass:[NSNull class]]) {
                ...
                [[STKit sharedInstance] updateToSubWithCid:model.c_id WithQSid:qsid WithCSid:model.cs_id WithQSTitle:model.qs_title WithQSDescInfo:model.qs_introduce WithQSContent:model.qs_content WithQSTime:versioin WithQSState:model.qs_state WithQS_ExtendedFlag:QIMNoteExtendedFlagStateRemoteUpdated];
                dispatch_async(dispatch_get_main_queue(), ^{
    ...
    [[STKit sharedInstance] sendTPPOSTRequestWithUrl:urlStr withRequestBodyData:data withSuccessCallBack:^(NSData *responseData) {
        ...
        if ([[infoDic objectForKey:@"ret"] integerValue] && [[infoDic objectForKey:@"errcode"] integerValue] == 0) {
            ...
            if (data && ![data isKindOfClass:[NSNull class]]) {
                ...
                NSInteger version = [[dict objectForKey:@"version"] integerValue];
                [[STKit sharedInstance] updateToSubItemTimeWithCSId:version WithQSTime:resultQSid WithQsExtendedFlag:QIMNoteExtendedFlagStateRemoteUpdated];
            }
        }
    } withFailedCallBack:^(NSError *error) {
    ...
    [[STKit sharedInstance] sendTPPOSTRequestWithUrl:urlStr withRequestBodyData:data withSuccessCallBack:^(NSData *responseData) {
        ...
        if ([[infoDic objectForKey:@"ret"] integerValue] && [[infoDic objectForKey:@"errcode"] integerValue] == 0) {
            ...
            if (data && ![data isKindOfClass:[NSNull class]]) {
                NSInteger resultQsid = [[dict objectForKey:@"qsid"] integerValue];
                NSInteger version = [[dict objectForKey:@"version"] integerValue];
                [[STKit sharedInstance] updateToSubItemTimeWithCSId:resultQsid WithQSTime:version WithQsExtendedFlag:QIMNoteExtendedFlagStateRemoteUpdated];
            }
        }
    } withFailedCallBack:^(NSError *error) {
        ...
        if ([[infoDic objectForKey:@"ret"] integerValue] && [[infoDic objectForKey:@"errcode"] integerValue] == 0) {
            ...
            if (data && ![data isKindOfClass:[NSNull class]]) {
                for (NSDictionary *dict in resultArray) {
                    ...
                    [[STKit sharedInstance] insertQTNotesSubItemWithCId:cid WithQSId:resultQsid WithCSId:model.cs_id WithQSType:resultType WithQSTitle:resultTitle WithQSIntroduce:resultDesc WithQSContent:resultContent WithQSTime:resultVersion WithQState:resultState WithQS_ExtendedFlag:QIMNoteExtendedFlagStateRemoteUpdated];
...
- (void)batchSyncToRemoteSubItemsWithInserts:(NSArray *)inserts updates:(NSArray *)updates {
    ...
    [[STKit sharedInstance] sendTPPOSTRequestWithUrl:urlStr withRequestBodyData:data withSuccessCallBack:^(NSData *responseData) {
        ...
        if ([[infoDic objectForKey:@"ret"] integerValue] && [[infoDic objectForKey:@"errcode"] integerValue] == 0) {
            NSArray *resultArray = [infoDic objectForKey:@"data"];
            if (data && ![data isKindOfClass:[NSNull class]]) {
                [[STKit sharedInstance] updateToSubItemWithDicts:resultArray];
            }
        }
    } withFailedCallBack:^(NSError *error) {
...
- (void)beginEncryptionSessionWithUserId:(NSString *)userId
    ...
    [[STKit sharedInstance] sendEncryptionChatWithType:QIMEncryptMessageType_Begin WithBody:passwordBody ToJid:userId];
}
...
- (void)agreeEncryptSessionWithUserId:(NSString *)userId {
    [[STKit sharedInstance] sendEncryptionChatWithType:QIMEncryptMessageType_Agree WithBody:@"同意" ToJid:userId];
}
...
- (void)refuseEncryptSessionWithUserId:(NSString *)userId {
    [[STKit sharedInstance] sendEncryptionChatWithType:QIMEncryptMessageType_Refuse WithBody:@"拒绝" ToJid:userId];
}
...
- (void)cancelEncryptSessionWithUserId:(NSString *)userId {
    [[STKit sharedInstance] sendEncryptionChatWithType:QIMEncryptMessageType_Cancel WithBody:[NSBundle qim_localizedStringForKey:@"Cancel"] ToJid:userId];
}
...
- (void)closeEncryptSessionWithUserId:(NSString *)userId {
    [[STKit sharedInstance] sendEncryptionChatWithType:QIMEncryptMessageType_Close WithBody:@"关闭" ToJid:userId];
}
...
- (QIMNoteModel *)getEncrptPwdBox {
    NSArray *pwdBoxs = [[STKit sharedInstance] getQTNotesMainItemWithQType:QIMNoteTypeChatPwdBox];
    if (pwdBoxs.count >= 1) {
        QIMNoteModel *model = [[QIMNoteModel alloc] init];
...
- (NSString *)getLocalEncryptChatPasswordWithUserId:(NSString *)userId
    ...
    QIMNoteModel *model = [[QIMNoteModel alloc] init];
    NSDictionary *pwdDict = [[STKit sharedInstance] getQTNotesSubItemWithCid:cid WithUserId:userId];
    if (pwdDict) {
