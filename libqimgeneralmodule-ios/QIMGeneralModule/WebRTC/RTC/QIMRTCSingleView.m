...
- (void)initUIForAudioCaller{
    ...
    imageView.image = [UIImage imageWithData:[STKit defaultUserHeaderImage]];
    [view addSubview:imageView];
    
    UILabel *nameLabel = [[UILabel alloc] init];
    NSString *text = [NSString stringWithFormat:@"你邀请%@音频通话", [[STKit sharedInstance] getUserMarkupNameWithUserId:self.remoteJid]];
...
- (void)initUIForAudioCallee {
    ...
    UILabel *nameLabel = [[UILabel alloc] init];
    NSString *text = [NSString stringWithFormat:@"%@邀请你音频通话", [[STKit sharedInstance] getUserMarkupNameWithUserId:self.remoteJid]];
    [nameLabel setText:text];
    [nameLabel setTextAlignment:NSTextAlignmentCenter];
    [view addSubview:nameLabel];
...
- (void)initUIForVideoCallee {
    ...
    UILabel *nameLabel = [[UILabel alloc] init];
    NSString *text = [NSString stringWithFormat:@"%@邀请你视频通话", [[STKit sharedInstance] getUserMarkupNameWithUserId:self.remoteJid]];
    [nameLabel setText:text];
    [nameLabel setTextAlignment:NSTextAlignmentCenter];
    [view addSubview:nameLabel];
...
- (void)updateRemoteUserInfoWithXmppId:(NSString *)xmppId {
    dispatch_async(dispatch_get_main_queue(), ^{
        self.headerImageView.image = [UIImage imageWithData:[STKit defaultUserHeaderImage]];
        self.nameLabel.text = [[STKit sharedInstance] getUserMarkupNameWithUserId:xmppId];
    });
}
