...
- (NSString *)getUserName {
    ...
    NSString *name = nil;
    NSDictionary *userInfo = [[STKit sharedInstance] getUserInfoByUserId:_userId];
    //备注
    NSString *remarkName = [[STKit sharedInstance] getUserMarkupNameWithUserId:userInfo[@"XmppId"]];
    if (remarkName) {
...
- (void)getHeaderImage {
    ...
    if(userInfo){
        ...
        if (urlStr) {
            ...
            NSData *imageData = [STKit defaultUserHeaderImage];
